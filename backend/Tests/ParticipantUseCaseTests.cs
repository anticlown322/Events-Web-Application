...
public class ParticipantUseCaseTests
{
    ...
    public async Task CreateParticipantUseCase_ShouldCreateParticipant_WhenParticipantDtoIsValid()
    {
        ...
        repositoryMock.Setup(repo => repo.Event
                .GetEventByIdAsync(eventId, false, cancellationToken))
        ...
        await useCase.ExecuteAsync(eventId, participantDto, trackChanges:false, cancellationToken);
    ...
    public async Task DeleteParticipantUseCase_ShouldDeleteParticipant_WhenParticipantExists()
    {
        ...
        repositoryMock.Setup(repo => repo.Participant
                .GetParticipantByIdAsync(eventId, participantId, false, cancellationToken))
        ...
        await useCase.ExecuteAsync(eventId, participantId, trackChanges:false, cancellationToken);
        ...
        repositoryMock.Verify(repo => 
            repo.Participant.GetParticipantByIdAsync(eventId, participantId, false, cancellationToken), Times.Once);
        repositoryMock.Verify(repo 
    ...
    public async Task GetParticipantsUseCase_ShouldReturnPagedResult_WhenParticipantsExist()
    {
        ...
        repositoryMock.Setup(repo => repo.Participant
                .GetParticipantsAsync(eventId, participantParameters, false, cancellationToken))
    ...
    public async Task GetParticipantByIdAsync_ShouldReturnParticipant_WhenParticipantExists()
    {
        ...
        var result = await useCase
            .ExecuteAsync(eventId, participantId, trackChanges: false, cancellationToken);
